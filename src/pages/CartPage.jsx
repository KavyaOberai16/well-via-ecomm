...
export default function CartPage() {
  ...
  const products = [
    ...
    { id: 3, image: '/p7.png', title: 'Meta-Gut Gummies', info: 'Pack of 30' }
  ];
      ...
      >
        ...
        <div className="flex flex-1 flex-col">
          ...
          <div className="mt-4 flex items-center justify-between">
            <p className="px-4 py-2 text-white alata-font rounded bg-[#133F30] text-white">
              ₹349
            </p>
  ...
  <h1 className="mt-10 text-center text-xl font-bold alata-font">
    Designed To Work Together
  </h1>

  <div className="mx-4 mt-6 flex gap-4 rounded-lg border p-4 shadow-sm">
    <img
      src="/p6.png"
      alt=""
      className="h-28 w-28 object-contain"
    ...
    <div className="flex flex-1 flex-col">
      ...
      <div className="mt-4 flex items-center justify-between">
            ...
            <button className="rounded bg-[#133F30] px-4 py-2 text-white alata-font">
          Add
        </button>

...
function KPICard({ label, icon: Icon, value, previousValue, deltaPct, format, tone = 'accent', loading }) {
  // Sense per metric. For v1 every metric is "more is better"; separating
  // this prop keeps the door open for refund-rate, return-rate etc.
